var positive =[];
var posQuote =["The magical girl must to work to balance \n her normal life domestic obligations, educational obligations, \n and interpersonal relationships with her duty to protect the world.", 
"I'm really excited about Haruka and Michiru's relationship, \n and keeping it true to the original. \n I think we're living in a really exciting time where \n that won’t be seen as scandalous. \n I think it’ll just be seen as a beautiful romance.",
"Reading the manga version of Sailor Moon when I was in college \n helped me come to terms with my own bisexuality and \n realize that I wanted a relationship with another girl like Haruka and Michiru had.",
"Speaking of that, Madoka's mother Junko is portrayed positively \n as a career woman with a stay-at-home husband who takes care of the baby. \n This is in contrast with career women in other anime, \n who are often seen as greedy, narcissistic villain \n types (like in Princess Jellyfish). Career women are also sometimes \n portrayed in anime as sluts (like Misato \n in Neon Genesis Evangelion). Puella Magi Madoka Magica in contrast \n seems to be speaking out about this trend by showing Junko as a positive \n (although somewhat imperfect) career woman.",
"The Japanese anime series about teen girls named Sailor Senshi \n fighting bad guys from outer space, \n was a hallmark of girls’ after-school cartoons. \n It was many kids’ gateway to anime but, more importantly, \n Sailor Moon proved that children’s programming that \n centered on empowered young women had serious commercial \n power and popular appeal.",
...
class hero{
	...
	constructor(){
		...
		var x = Math.floor(Math.random()*(width));;
		var y = Math.floor(Math.random()*(height/2)+height/2);
		buttons.push(createButton(this.quote));
